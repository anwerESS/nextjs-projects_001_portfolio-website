      ...
      <div>
        <div className="fley flex-col items-center justify-center gap-y-3 font-light capitalize">
          ...
          >
            ...
            <Image src={"/person.png"} alt="Person Image" width={400} height={400} priority={true}
          ...
          <h1 className="text-center text-3xl font-bold tracking-wider text-gray-500 sm:text-2xl"> My Name is Anouar CHELAYFA</h1>
        ...
        <div className="mt-8 flex justify-center gap-10 text-yellow-600">
          {heroIcons.map((icon, i) => (
            <a href="#" key={i} className="hover:bg-red-400 hover:text-white transition-colors">{icon}</a>
          ))}
        </div>
        <a href="#"
